          ...
          <div className="px-8 py-6 space-y-6">
              {user && (
                <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4 mb-4">
                  <p className="text-blue-700 font-semibold">Registering as: {user.displayName || 'User'}</p>
                </div>
              )}
            ...
            <div className="p-4 bg-gray-50 rounded-lg border border-gray-200 mt-2">
              <p className="text-sm text-gray-500">
                <span className="font-semibold">Note:</span> Entry time will be automatically set to current date and time.
              </p>
            </div>
